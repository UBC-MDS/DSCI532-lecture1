...
- **Data dashboards are a summary of different, but related data sets, presented in a way that makes the information easier to understand**. 
...
- ... take data from different sources and aggregate it so **non-technical people can more easily read and interpret it**.
...
- Comparison among technologies: blogposts
    ...
    - [Tableau vs Shiny](https://appsilon.com/tableau-vs-r-shiny/)
...
![](img/inputs.png){.r-stretch fig-align="center"}
:::footer
...
5. Create and deploy a basic Shiny R app.
